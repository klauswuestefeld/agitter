...
public class EventTest extends Assert {
	...
	public void Equals() throws BusinessException, ParseException {
		Event event = Event.createFor(1, _altieres, "descrição", Application.strToDate("12/05/2010 10:32"));
		Event anotherEvent = Event.createFor(1, _altieres, "descrição", Application.strToDate("12/05/2010 10:32"));
	...
	public void EventCreateFor() throws BusinessException, ParseException {
		Event event = _eventHome.createFor(_altieres, "meu nascimento!", Application.strToDate("25/12/1981 10:30"));
		
		assertEquals(1, _eventHome.count());
		
		assertSame(_altieres, event.getModerator());
		assertEquals("meu nascimento!", event.getDescription());
		assertEquals(Application.strToDate("25/12/1981 10:30"), event.getDate());
	}
	
	@Test
	public void EventErrorsForConstruction() throws ParseException {
		String[] errorsNotFound = Event.errorsForConstruction(_altieres, "meu nascimento!", Application.strToDate("25/12/1981 10:30"));
	...
	public void removeEvent() throws BusinessException, ParseException {
		_eventHome.createFor(_altieres, "meu nascimento!", Application.strToDate("25/12/1981 10:30"));
	...
	public void sortEvents() throws BusinessException, ParseException {
		...
		Event evento3 = _eventHome.createFor(_maoki, "nascimento!", Application.strToDate("16/04/1984 09:20"));
		Event evento4 = _eventHome.createFor(_altieres, "festa em 2100!", Application.strToDate("25/12/2050 11:00"));
		Event evento2 = _eventHome.createFor(_altieres, "meu nascimento!", Application.strToDate("25/12/1981 10:30"));
		Event evento1 = _eventHome.createFor(_altieres, "meia hora antes do meu nascimento!", Application.strToDate("25/12/1981 10:00"));
	...
	public void listEventsIgnoreOlders() throws Exception {
		Date sinceDate = Application.strToDate("10/10/2010 10:00");
		
		Event evento1 = _eventHome.createFor(_altieres, "meia hora depois", Application.strToDate("10/10/2010 10:30"));
		_eventHome.createFor(_altieres, "meia hora antes", Application.strToDate("10/10/2010 09:30"));
		_eventHome.createFor(_altieres, "tres horas antes", Application.strToDate("10/10/2010 07:00"));
	...
	public void homeIdGeneration() throws BusinessException, ParseException {
		Event event = _eventHome.createFor(_altieres, "festa em 2100!", Application.strToDate("25/12/2050 11:00"));
		assertEquals(1, event.getId());
		
		event = _eventHome.createFor(_altieres, "festa em 2100!", Application.strToDate("25/12/2050 11:00"));
