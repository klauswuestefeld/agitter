...
import agitter.client.DateTimeUtilsClient;
...
public class EventsWidget extends Composite {
	...
	void addEventButtonClick(ClickEvent ignored) {
		addEvent();
	}
	...
	void feedbackLinkClick(ClickEvent ignored) {
		feedbackDialog.setVisible(true);
		feedbackDialog.center();
	}
	
	@UiHandler("logout")
	void logoutLinkClick(ClickEvent ignored) {
		_presenter.logout();
	}
	
	@UiHandler("addContactButton")
	void addContactButtonClick(ClickEvent ignored) {
		addContact();
	}
